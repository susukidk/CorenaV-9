...
class CreateArbolesfrutalesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('arbolesfrutales', function (Blueprint $table) {
            $table->id('folioarbolesfrutales');
            ...
            $table->string('CultivoPrincipal')->default('N/A');
    ...
    {
        Schema::dropIfExists('arbolesfrutales');
    }
}
