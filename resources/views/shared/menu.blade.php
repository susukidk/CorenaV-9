...
<nav class="navbar navbar-expand-lg navbar-light bg-transparent fixed-top">
  <div class="container-fluid">
    <div class="d-flex align-items-center">
      ...
      <div class="ml-auto">
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="{{ route('compostas.index') }}">
              <button class="btn btn-primary tab-btn">Compostas</button>
            </a>
          </li>
          <li class="nav-item">
          <a class="nav-link" href="{{ route('mecanizacion.index') }}">
              <button class="btn btn-primary tab-btn">Mecanización</button>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="{{ route('arbolesfrutales.index') }}">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="btn usuarioestilo" href="{{ route('registrarUsuario') }}">
            <i class="icocod">&#128315;</i> Agregar Usuario
          </a>
        </li>
      </ul>
      <form class="d-flex">
        <a href="{{ route('logout') }}" class="btn logout-btn">
          <i class="icocod">&#127939;</i> Salir del sistema
        </a>
      </form>
    </div>
  </div>
