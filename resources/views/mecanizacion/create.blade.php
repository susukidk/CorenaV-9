...
<form class="row g-3 fs-4" action="{{ route('mecanizacion.store') }}" method="post">
    @csrf
    @method('POST')
    ...
    <div class="col-12 mt-4">
        <label for="CultivoEstablecidos" >Cultivo(s) establecido(s)</label>
        <input type="text" name="CultivoEstablecidos" id="CultivoEstablecidos" class="form-control" value="{{ old('CultivoEstablecidos') }}">
    </div>
